...
export interface LanguageAdapter {
  ...
  // Performance optimization: Accept TreeCursor instead of string property to avoid
  // expensive WASM boundary crossing (property access) when not needed by the adapter.
