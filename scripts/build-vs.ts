...
console.log(
  'Visual Studio extension artifacts prepared in packages/visual-studio-extension/Resources',
);
console.log(
  'You can now open packages/visual-studio-extension/CognitiveComplexity.sln in Visual Studio to build the VSIX.',
);
